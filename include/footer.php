    <footer class="footer">
      ...
      <!-- <div class="custom-shape-divider-bottom-1723991056">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100% 100">
          <path fill="" class="shape-fill" fill-opacity="1" d="M0,192L48,192C96,192,192,192,288,170.7C384,149,480,107,576,117.3C672,128,768,192,864,202.7C960,213,1056,171,1152,138.7C1248,107,1344,85,1392,74.7L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div> -->
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-4 col-12">
            ...
            <div class="footer-contact-div">
              <i class="fi fi-rr-marker"></i>79 Sleepy Hollow St. Jamaica, New York 1432
            </div>
            <a href="tel:+919999999999" class="footer-contact-div">
              <i class="fi fi-rr-mobile-button"></i>+91 99999 99999
            </a>
            <a href="mailto:demo@gmail.com" class="footer-contact-div mb-0">
              <i class="fi fi-rr-envelope"></i>demo@gmail.com
            </a>
          </div>
        </div>
      </div>
      <div class="container footer-bottom-container">
        <div class="row row-gap20">
          <div class="col-lg-8"><p class="copyright-text">© 2023 All Rights Reserved | Develope by lorem.</p></div>
          <div class="col-lg-4">
            <div class="payment-icon-div">
              ...
              <div class="payment-icon">
                <img src="./assets/images/mastercard.png" alt="visa">
              </div>
              <div class="payment-icon">
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                  ...
                  <div class="login-item">
                    ...
                    <form autocomplete="off">
                      <div class="row">
                        ...
                        <div class="col-12">
                          <button type="submit" class="submit-btn common-btn common-btn2">Login</button>
                        </div>
                        <!-- <p class="forgot-password-link signup-link">Login With Your Email Id? <a href="javascript:void(0)">Click Here To Login</a></p> -->
                        <p class="forgot-password-link signup-link">Login With Your Phone Number? <a
                          href="javascript:void(0)">Click Here To Login</a></p>
                        <p class="forgot-password-link signup-link">Forgot Your Password? <a href="javascript:void(0)">Reset
                            It Here</a>
                        </p>
          ...
          <!-- <div class="modal-footer">
                ...
                <button type="button" class="common-btn common-btn2">Lo</button>
              </div> -->
        </div>
      </div>
    </div>
