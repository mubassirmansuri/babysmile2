<?php include 'include/header.php'?>
                ...
                <div class="product-item">
                  ...
                  <div class="product-img-div">
                    ...
                    <div class="add-cart-div">
                      <a href="javascript:void(0)" class="add-cart-link2"data-bs-container="body" data-bs-toggle="tooltip" data-bs-placement="left" title="Buy Now"><i class="fi fi-rr-shopping-cart-add"></i></a>
  ...
  <section class="discount-section section-padding pt-0">
    <div class="container">
      <div class="row row-gap20">
        <!-- <div class="col-12">
          <div class="discount-item">
            <img src="./assets/images/demo-img-4.jpg" alt="discount-img" class="discount-img">
            <div class="discount-content">
              <h3 class="discount-off-titel">20% <sub>OFF</sub> </h3>
              <h4 class="discount-titel">Lorem ipsum dolor sit amet</h4>
              <p class="discount-type">Gift Pack</p>
        ...
        <div class="col-lg-6">
          <div class="discount-item">
            ...
            <div class="discount-content">
              <h4 class="discount-titel">Lorem ipsum dolor sit amet</h4>
              <p class="discount-type">Baby Planet's</p>
              <a href="javascript:void(0)" title="View Product" class="common-btn">View Product</a>
            </div>
          </div>
        </div>
              ...
              <div class="swiper-slide">
                <a href="javascript:void(0)" class="brand-item">
                  <div class="brand-icon-div">
                    <img src="./assets/images/logo.png" alt="demo" class="brand-icon">
                  </div>
                </a>
              </div>
              <div class="swiper-slide">
      ...
      <div class="row row-cols-lg-5 row-cols-sm-3 row-cols-2 row-gap20">
        <div class="col">
          <div class="processing-item">
            ...
            <p class="processing-title">Add To Cart</p>
          </div>
        </div>
        <div class="col">
          <div class="processing-item">
            ...
            <p class="processing-title">Order Placement</p>
          </div>
        </div>
        <div class="col">
          <div class="processing-item">
            ...
            <p class="processing-title">Packing</p>
          </div>
        </div>
        <div class="col">
          <div class="processing-item">
            ...
            <p class="processing-title">Sorting</p>
          </div>
        </div>
        <div class="col">
          <div class="processing-item">
            ...
            <p class="processing-title">Shipping</p>
          </div>
        </div>
      </div>
    </div>
